...
obs_info = {
    ...
    'n_exp': 8, #number of exposure for y-band (not simulated here), csst have 4 exposures
    'exp_time': [2000, 2000, 2000, 2000], #total expsoure time
    'survey_area': 400, #in deg^2 unit
    'readout': 5.0, #e-/pix
